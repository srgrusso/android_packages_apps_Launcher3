...
import com.android.launcher3.StagLauncher;
import com.android.launcher3.StagLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        StagLauncher launcher = (StagLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        StagLauncherModelDelegate delegate = (StagLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        StagLauncher launcher = (StagLauncher) ActivityContext.lookupContext(getContext());
