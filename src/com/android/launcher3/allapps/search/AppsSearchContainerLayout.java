...
public class AppsSearchContainerLayout extends ExtendedEditText
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // Write the above using ternary operator
        setCompoundDrawablesRelativeWithIntrinsicBounds(Utilities.showQSB(getContext()) ?
            (Themes.isThemedIconEnabled(getContext()) ? gIconThemed : gIcon) : sIcon, null, null, null);
