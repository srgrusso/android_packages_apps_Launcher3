...
public class StagLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "StagLauncherModelDelegate";
    ...
    public StagLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
